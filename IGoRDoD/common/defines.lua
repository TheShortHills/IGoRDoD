...
economy = {
	...
	TRADE_CAP_LOW_LIMIT_NAVAL = .5, 			-- the lowest % the slider can go for naval units
...
military = {
	...
	NAVAL_COMBAT_RETREAT_MIN_DISTANCE = 1, -- how close (in average) all alive ships must be to the center line to be able to retreat.
	...
	NAVAL_LOW_SUPPLY_DAMAGE_SUPPLY_STATUS = 0.95, -- how little supply is acceptable before getting damage to STR
